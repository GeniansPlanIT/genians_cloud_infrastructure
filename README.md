...
- 한계 및 전환 사유:
  ...
  -  새로운 공격 패턴이 나올 때마다 재학습 해야 하는 MLOps 비용 부담으로 인해, 일반화 성능이 뛰어난 LLM 기반 RAG 방식으로 전환 결정

2. 시도2: RAG 기반의 LLM 그룹핑
